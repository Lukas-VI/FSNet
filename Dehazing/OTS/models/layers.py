...
# ============================================================
# FSNet 的基础网络层模块（OTS 版本）
# 与 ITS 版本相比，额外实现了 AvgPool2d（可自适应调整池化核大小的均值池化），
# 并让 Gap / SFconv / Patch_ap 里的池化改用 AvgPool2d（而非固定 1x1 自适应池化）。
...
class Gap(nn.Module):
    ...
    def __init__(self, in_channel) -> None:
        ...
        self.gap = AvgPool2d(base_size=210)  # 相对 256 训练尺寸的基准池化核为 210
...
class SFconv(nn.Module):
    ...
    def __init__(self, features, M=2, r=2, L=32) -> None:
        ...
        # self.gap = nn.AdaptiveAvgPool2d(1)
        self.gap = AvgPool2d(base_size=210)          # 用可调池化
...
class Patch_ap(nn.Module):
    ...
    def __init__(self, inchannel, patch_size):
        ...
        self.ap = AvgPool2d(base_size=210)   # 可调池化
